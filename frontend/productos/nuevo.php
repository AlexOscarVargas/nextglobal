    ...
    <div class="main-content">
        ...
        <main>
            ...
            <div class="page-header">
                ...
                <small>Home / Activos / Nuevo</small>
            </div>
...
<form action="" enctype="multipart/form-data" method="POST"  autocomplete="off">
  ...
  <strong>Importante!</strong> Es importante rellenar los campos con &nbsp;<span class="badge-warning">*</span>
    ...
    <label for="email"><b>Código del activo</b></label><span class="badge-warning">*</span>
    <input type="text"   maxlength="14" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;"name="prdcod"  required>
  
    <label for="email"><b>Nombre del activo</b></label><span class="badge-warning">*</span>
    <input type="text"  name="prdnom"  required>

    <label for="email"><b>Descripción del activo</b></label><span class="badge-warning">*</span>
    <textarea required name="prddes" id="consl" required  style="height:200px"></textarea>

    <label for="email"><b>Precio del activo</b></label><span class="badge-warning">*</span>
    <input type="text" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;"   name="prdprec"  required>

    <label for="email"><b>Stock del activo</b></label><span class="badge-warning">*</span>
    <input type="text" maxlength="3" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;"  name="prdstco"  required>

    <label for="psw"><b>Marca del activo</b></label><span class="badge-warning">*</span>
    ...
    <label for="psw"><b>Categoria del activo</b></label><span class="badge-warning">*</span>
    <select required name="prdcate" id="cat">
        <option>Seleccione</option>
    </select>

    <label for="email"><b>Modelo del activo</b></label><span class="badge-warning">*</span>
    <input type="text"  name="prdmod"  required>

    <label for="email"><b>Peso del activo</b></label><span class="badge-warning">*</span>
    <input type="text"  name="prdpes"  required>

    <label for="email"><b>Foto del activo</b></label><span class="badge-warning">*</span>
