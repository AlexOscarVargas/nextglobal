    ...
    <div class="main-content">
        ...
        <main>
            ...
            <div class="page-header">
                ...
                <small>Home / Activos / Actualizar</small>
            </div>
...
<form action="" enctype="multipart/form-data" method="POST"  autocomplete="off">
  ...
  <strong>Importante!</strong> Es importante rellenar los campos con &nbsp;<span class="badge-warning">*</span>
    ...
    <input type="text" value="<?php echo $d->nomprd; ?>"  name="prdnom"  required>

    <label for="email"><b>Descripción del activo</b></label><span class="badge-warning">*</span>
    <textarea required value="<?php echo $d->desprd; ?>" name="prddes" id="consl" required  style="height:200px"><?php echo $d->desprd; ?></textarea>

    <label for="email"><b>Precio del activo</b></label><span class="badge-warning">*</span>
    <input type="text" value="<?php echo $d->precio; ?>"  name="prdprec"  required>
...
while($row=$stmt->fetch(PDO::FETCH_ASSOC))
    ...
    <input type="text" value="<?php echo $d->modelo; ?>"  name="prdmod"  required>

     <label for="email"><b>Peso del activo</b></label><span class="badge-warning">*</span>
    <input type="text" value="<?php echo $d->peso; ?>"  name="prdpes"  required>
