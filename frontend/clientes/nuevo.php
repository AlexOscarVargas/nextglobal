    ...
    <div class="main-content">
        ...
        <main>
            ...
            <div class="page-header">
                ...
                <small>Home / Empleados / Nuevo</small>
            </div>
...
<form action="" enctype="multipart/form-data" method="POST"  autocomplete="off">
  ...
  <strong>Importante!</strong> Es importante rellenar los campos con &nbsp;<span class="badge-warning">*</span>
    ...
    <input type="text" maxlength="8" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;"  name="numcl"  required>

    <label for="email"><b>Nombre del empleado</b></label><span class="badge-warning">*</span>
    <input type="text"  name="nomcl"  required>

    <label for="email"><b>Apellido del empleado</b></label><span class="badge-warning">*</span>
    <input type="text"  name="apecl"  required>

    <label for="email"><b>Teléfono celular del empleado</b></label><span class="badge-warning">*</span>
    <input type="text" maxlength="9" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;"  name="telcl"  required>
