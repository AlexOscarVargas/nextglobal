    ...
    <div class="main-content">
        ...
        <main>
            ...
            <div class="page-header">
                ...
                <small>Home / Empleados / Perfil</small>
            </div>
...
<form action="" enctype="multipart/form-data" method="POST"  autocomplete="off">
  <div class="containerss">
    <h1>Nuevo perfil de los empleados</h1>
  ...
  <strong>Importante!</strong> Es importante rellenar los campos con &nbsp;<span class="badge-warning">*</span>
    ...
    <input type="text" value="<?php echo $d->nocl; ?> &nbsp; <?php echo $d->apcl; ?>"  disabled>
  
    <label for="email"><b>Nombre del usuario del empleado</b></label><span class="badge-warning">*</span>
    <input type="text"  name="usrcl"  required>
    <input type="hidden" name="clid" value="<?php echo $d->idcli; ?>">

    <label for="email"><b>Contraseña del empleado</b></label><span class="badge-warning">*</span>
    <input type="password"  name="pswcl"  required>
