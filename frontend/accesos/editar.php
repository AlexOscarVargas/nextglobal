    ...
    <div class="main-content">
        ...
        <main>
            ...
            <div class="page-header">
                ...
                <small>Home / Usuarios / Actualizar</small>
            </div>
...
<form action="" enctype="multipart/form-data" method="POST"  autocomplete="off">
  ...
  <strong>Importante!</strong> Es importante rellenar los campos con &nbsp;<span class="badge-warning">*</span>
    ...
    <input type="text" name="nomuse" required value="<?php echo $d->nombre; ?>" >


    <label for="email"><b>Nombre de usuario del acceso</b></label>
    <input type="text" name="namuse" required value="<?php echo $d->username; ?>" >  

    <label for="email"><b>Correo de usuario</b></label>
    <input type="text" name="corruse" required value="<?php echo $d->correo; ?>" >  
